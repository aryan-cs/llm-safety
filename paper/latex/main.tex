...
Primary behavioral analysis: \PrimaryRunId. The table below is populated from the corresponding analysis artifact when present.
...
Qualitative examples should be summarized at the category level rather than reproduced verbatim when they contain procedural harmful details.
